  ...
  return (
    <div className="overflow-hidden">
      <div className="px-3 py-2.5">
        {title && (
          <div className="mb-2 text-left font-bold text-current text-xs opacity-90">
            {title}
          </div>
        )}
          ...
          {rows.map((row) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                />
                <span className="font-semibold text-current text-xs sm:text-sm opacity-90">
                  {row.label}
                </span>
              </div>
              <span className="font-bold text-current text-xs sm:text-sm tabular-nums">
